...
def get_metrics(input_file):
    ...
    return avg_latency, avg_thput, pkt_loss_rate
...
if __name__ == "__main__":
    ...
    avg_latency, avg_thput, pkt_loss_rate = get_metrics(args.data_file)
    print("Average Latency (seconds): ","%.5f" % avg_latency)
    print("Average Thoroughput(packets/s):","%.3f" % avg_thput)
