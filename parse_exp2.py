...
def get_metrics2(input_file):
    ...
    return avg_latency, avg_thput, pkt_loss_rate,avg_latency2,avg_thput2,pkt_loss_rate2
...
if __name__ == "__main__":
    ...
    print("Packet Loss Rate for TCP flow1:","%.3f" % pkt_loss_rate)

    print("Average Latency for TCP flow 2 (seconds): ","%.5f" % avg_latency2)
    print("Average Thoroughput for TCP flow 2 (packets/s):","%.3f" % avg_thput2)
    print("Packet Loss Rate for TCP flow 2:","%.3f" % pkt_loss_rate2)